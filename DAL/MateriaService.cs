...
{
	/// <summary>
	/// 数据访问类:MateriaService
	/// </summary>
	public partial class MateriaService
	{
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Materia");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Materia ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,materiaName,materiaValue,status,remark,addTime,addUser,infoType ");
			strSql.Append(" FROM Materia ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,materiaName,materiaValue,status,remark,addTime,addUser,infoType ");
			strSql.Append(" FROM Materia ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Materia T ");
