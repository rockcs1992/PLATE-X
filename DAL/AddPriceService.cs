...
{
	/// <summary>
	/// 数据访问类:AddPriceService
	/// </summary>
	public partial class AddPriceService
	{
		...
		/// 增加一条数据
		/// </summary>
		public static int Add(Model.AddPrice model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into AddPrice(");
			strSql.Append("productId,price,addUser,addTime,status,remark,infoType)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.AddPrice model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.AddPrice GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,productId,price,addUser,addTime,status,remark,infoType from AddPrice ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.AddPrice model=new Model.AddPrice();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.AddPrice DataRowToModel(DataRow row)
		{
			Model.AddPrice model=new Model.AddPrice();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,productId,price,addUser,addTime,status,remark,infoType ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,productId,price,addUser,addTime,status,remark,infoType ");
			strSql.Append(" FROM AddPrice ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
