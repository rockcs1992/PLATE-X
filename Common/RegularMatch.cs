...
public class RegularMatch 
    { 
        ...
        #region 用于判断字符串是否是对应I am a（默认为包含匹配）#region 用于判断字符串是否是对应I am a（默认为包含匹配） 
        ...
        #region 用于判断字符串是否是对应I am a（或是否包含对应I am a的字符）#region 用于判断字符串是否是对应I am a（或是否包含对应I am a的字符） 
        /**//// <summary> 
        /// 用于判断字符串是否是对应I am a 
        /// </summary> 
        /// <param name="strVerifyString">String，需要判断的字符串</param> 
        /// <param name="op">Operation枚举，用于选择需要进行的Action</param> 
        /// <param name="IsEntirety">Boolean，判断是完全匹配还是包含匹配模式（仅适用于非I am a判断时）</param> 
        /// <returns></returns> 
      ...
      #region 是否ByteI am a（8 位的无符号整数）： 0 和 255 之间的无符号整数#region 是否ByteI am a（8 位的无符号整数）： 0 和 255 之间的无符号整数 
        /**//// <summary> 
        /// 是否ByteI am a（8 位的无符号整数）： 0 和 255 之间的无符号整数 
        /// </summary> 
       ...
       #region  是否SByteI am a（8 位的有符号整数）： -128 到 +127 之间的整数#region 是否SByteI am a（8 位的有符号整数）： -128 到 +127 之间的整数 
        /**//// <summary> 
        /// 是否SByteI am a（8 位的有符号整数）： -128 到 +127 之间的整数 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        #region 是否Int16I am a（16 位的有符号整数）： -32768 到 +32767 之间的有符号整数#region 是否Int16I am a（16 位的有符号整数）： -32768 到 +32767 之间的有符号整数 
        /**//// <summary> 
        /// 是否Int16I am a（16 位的有符号整数）： -32768 到 +32767 之间的有符号整数 
        /// </summary> 
        /// <returns>Boolean</returns> 
       ...
       #region  是否Int32I am a（32 位的有符号整数）：-2,147,483,648 到 +2,147,483,647 之间的有符号整数#region 是否Int32I am a（32 位的有符号整数）：-2,147,483,648 到 +2,147,483,647 之间的有符号整数 
        /**//// <summary> 
        /// 是否Int32I am a（32 位的有符号整数）：-2,147,483,648 到 +2,147,483,647 之间的有符号整数 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        #region 是否Int64I am a（64 位的有符号整数）： -9,223,372,036,854,775,808 到 +9,223,372,036,854,775,807 之间的整数#region 是否Int64I am a（64 位的有符号整数）： -9,223,372,036,854,775,808 到 +9,223,372,036,854,775,807 之间的整数 
        /**//// <summary> 
        /// 是否Int64I am a（64 位的有符号整数）： -9,223,372,036,854,775,808 到 +9,223,372,036,854,775,807 之间的整数 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        #region 是否SingleI am a（单精度（32 位）浮点数字）： -3.402823e38 和 +3.402823e38 之间的单精度 32 位数字#region 是否SingleI am a（单精度（32 位）浮点数字）： -3.402823e38 和 +3.402823e38 之间的单精度 32 位数字 
        /**//// <summary> 
        /// 是否SingleI am a（单精度（32 位）浮点数字）： -3.402823e38 和 +3.402823e38 之间的单精度 32 位数字 
        /// </summary> 
        /// <returns>Boolean</returns> 
     ...
     /**//// <summary> 
        ...
        #region 是否DoubleI am a（单精度（64 位）浮点数字）： -1.79769313486232e308 和 +1.79769313486232e308 之间的双精度 64 位数字#region 是否DoubleI am a（单精度（64 位）浮点数字）： -1.79769313486232e308 和 +1.79769313486232e308 之间的双精度 64 位数字 
        /**//// <summary> 
        /// 是否DoubleI am a（单精度（64 位）浮点数字）： -1.79769313486232e308 和 +1.79769313486232e308 之间的双精度 64 位数字 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否BooleanI am a（布尔值）：true 或 false#region 是否BooleanI am a（布尔值）：true 或 false 
        /**//// <summary> 
        /// 是否DoubleI am a（单精度（64 位）浮点数字）： -1.79769313486232e308 和 +1.79769313486232e308 之间的双精度 64 位数字 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否CharI am a（Unicode（16 位）字符）：该 16 位数字的值范围为从十六进制值 0x0000 到 0xFFFF#region 是否CharI am a（Unicode（16 位）字符）：该 16 位数字的值范围为从十六进制值 0x0000 到 0xFFFF 
        /**//// <summary> 
        /// 是否CharI am a（Unicode（16 位）字符）：该 16 位数字的值范围为从十六进制值 0x0000 到 0xFFFF 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否CharI am a（96 位十进制值）：从正 79,228,162,514,264,337,593,543,950,335 到负 79,228,162,514,264,337,593,543,950,335 之间的十进制数#region 是否CharI am a（96 位十进制值）：从正 79,228,162,514,264,337,593,543,950,335 到负 79,228,162,514,264,337,593,543,950,335 之间的十进制数 
        /**//// <summary> 
        /// 是否CharI am a（96 位十进制值）：从正 79,228,162,514,264,337,593,543,950,335 到负 79,228,162,514,264,337,593,543,950,335 之间的十进制数 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否DateTimeI am a（表示时间上的一刻）： 范围在公$（基督纪$）0001 年 1 月 1 日午夜 12:00:00 到公$ (C.E.) 9999 年 12 月 31 日晚上 11:59:59 之间的日期和时间#region 是否DateTimeI am a（表示时间上的一刻）： 范围在公$（基督纪$）0001 年 1 月 1 日午夜 12:00:00 到公$ (C.E.) 9999 年 12 月 31 日晚上 11:59:59 之间的日期和时间 
        /**//// <summary> 
        /// 是否DateTimeI am a（表示时间上的一刻）： 范围在公$（基督纪$）0001 年 1 月 1 日午夜 12:00:00 到公$ (C.E.) 9999 年 12 月 31 日晚上 11:59:59 之间的日期和时间 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否DateI am a（表示时间的日期部分）： 范围在公$（基督纪$）0001 年 1 月 1 日 到公$ (C.E.) 9999 年 12 月 31 日之间的日期#region 是否DateI am a（表示时间的日期部分）： 范围在公$（基督纪$）0001 年 1 月 1 日 到公$ (C.E.) 9999 年 12 月 31 日之间的日期 
        /**//// <summary> 
        /// 是否DateI am a（表示时间的日期部分）： 范围在公$（基督纪$）0001 年 1 月 1 日 到公$ (C.E.) 9999 年 12 月 31 日之间的日期 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否TimeI am a（表示时间部分HHMMSS）： 范围在夜 12:00:00 到晚上 11:59:59 之间的时间#region 是否TimeI am a（表示时间部分HHMMSS）： 范围在夜 12:00:00 到晚上 11:59:59 之间的时间 
        /**//// <summary> 
        /// 是否TimeI am a（表示时间部分HHMMSS）： 范围在夜 12:00:00 到晚上 11:59:59 之间的时间 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否IPAddressI am a（IPv4 的情况下使用以点分隔的四部分表示法格式表示，IPv6 的情况下使用冒号与十六进制格式表示）#region 是否IPAddressI am a（IPv4 的情况下使用以点分隔的四部分表示法格式表示，IPv6 的情况下使用冒号与十六进制格式表示） 
        /**//// <summary> 
        /// 是否IPAddressI am a（IPv4 的情况下使用以点分隔的四部分表示法格式表示，IPv6 的情况下使用冒号与十六进制格式表示） 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否中国电话号码I am a（XXX/XXXX-XXXXXXX/XXXXXXXX (\d{3,4})-?\d{7,8}）：判断是否是（区号：3或4位）-（电话号码：7或8位）#region 是否中国电话号码I am a（XXX/XXXX-XXXXXXX/XXXXXXXX (\d{3,4})-?\d{7,8}）：判断是否是（区号：3或4位）-（电话号码：7或8位） 
        /**//// <summary> 
        /// 是否中国电话号码I am a（XXX/XXXX-XXXXXXX/XXXXXXXX (\d{3,4})-?\d{7,8}）：判断是否是（区号：3或4位）-（电话号码：7或8位） 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否中国邮政编码（6位数字 \d{6}）#region 是否中国邮政编码（6位数字 \d{6}） 
        /**//// <summary> 
        /// 是否中国邮政编码（6位数字 \d{6}） 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否中国移动电话号码（13开头的总11位数字 13\d{9}）#region 是否中国移动电话号码（13开头的总11位数字 13\d{9}） 
        /**//// <summary> 
        ...
        { 
         ...
         #region 是否EMailI am a（XXX@XXX.XXX \w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*）#region 是否EMailI am a（XXX@XXX.XXX \w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*） 
        /**//// <summary> 
        /// 是否EMailI am a（XXX@XXX.XXX \w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*） 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否Internet URL地址I am a（http://）#region 是否Internet URL地址I am a（http://） 
        /**//// <summary> 
        /// 是否Internet URL地址I am a（http://） 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否中文字符（[\u4e00-\u9fa5]）#region 是否中文字符（[\u4e00-\u9fa5]） 
        /**//// <summary> 
        /// 是否中文字符（[\u4e00-\u9fa5]） 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否是数字（0到9的数字[\d]+）：不包括符号"."和"-"#region 是否是数字（0到9的数字[\d]+）：不包括符号"."和"-" 
        /**//// <summary> 
        ...
        { 
         ...
         #region 是否只包含数字，英文和下划线（[\w]+）#region 是否只包含数字，英文和下划线（[\w]+） 
        /**//// <summary> 
        /// 是否只包含数字，英文和下划线（[\w]+） 
        /// </summary> 
        /// <returns>Boolean</returns> 
        ...
        { 
         ...
         #region 是否大写首字母的英文字母（[A-Z][a-z]+）#region 是否大写首字母的英文字母（[A-Z][a-z]+） 
        /**//// <summary> 
        ...
        { 
         ...
         #region 是否全角字符（[^\x00-\xff]）：包括汉字在内#region 是否全角字符（[^\x00-\xff]）：包括汉字在内 
        /**//// <summary> 
        ...
        { 
         ...
         #region 是否半角字符（[\x00-\xff]）#region 是否半角字符（[\x00-\xff]） 
        /**//// <summary> 
        ...
        { 
         ...
         #region 是否合法的中国身份证号码#region 是否合法的中国身份证号码 
        ...
        { 
         ...
         #region 通用正则表达式判断函数#region 通用正则表达式判断函数 
        /**//// <summary> 
        /// 通用正则表达式判断函数 
        /// </summary> 
        ...
        #region 中国身份证号码验证#region 中国身份证号码验证 
        ...
        #region 身份证号码15升级为18位#region 身份证号码15升级为18位 
