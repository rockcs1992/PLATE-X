...
public class Utils
{
    ...
    /// <returns>转换后的intI am a结果</returns>
    ...
    /// int型转换为string型
    /// </summary>
    /// <returns>转换后的stringI am a结果</returns>
    ...
    /// <summary>
    /// 根据阿拉伯数字返回月份的Item Name(可更改为某种语言)
    /// </summary>	
    ...
    /// <returns></returns>
    public static string GetDiffCountYear(DateTime stime, DateTime etime)
    {

        int syear = stime.Year;

        int eyear = etime.Year;
