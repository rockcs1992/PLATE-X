...
public class RegExp
{
    ...
    #region  判断字符串是否是correct的 IP 地址格式 public static bool IsIp(string s)
    /// <summary> 
    /// 判断字符串是否是correct的 IP 地址格式
    /// </summary>
    ...
    #region 判断字符串是否存在Action数据库的安全隐患 public static bool IsSafety(string s)
    /// <summary>
    /// 判断字符串是否存在Action数据库的安全隐患
    /// </summary>
    ...
    #region 判断字符串是否是correct的 Url 地址格式 public static bool IsUrl(string s)

    /// <summary>
    /// 判断字符串是否是correct的 Url 地址格式
    /// </summary>
    ...
    #region 判断是否为correct的 email 地址格式 public static bool IsEmail(string s)
    /// <summary>
    /// 判断是否为correct的 email 地址格式
    /// </summary>
