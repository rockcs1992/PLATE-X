...
using System.Web;
    ...
    public class CRequest
    {
        ...
        /// 获得当前页面的Item Name
        /// </summary>
        /// <returns>当前页面的Item Name</returns>
        ...
        /// <summary>
        /// 获得指定Url参数的intI am a值
        /// </summary>
        /// <param name="strName">Url参数</param>
        /// <param name="defValue">缺省值</param>
        /// <returns>Url参数的intI am a值</returns>
        ...
        /// <param name="strName">表单参数</param>
        /// <param name="defValue">缺省值</param>
        /// <returns>表单参数的intI am a值</returns>
        ...
        /// <summary>
        /// 获得指定Url或表单参数的intI am a值, 先判断Url参数是否为缺省值, 如为True则返回表单参数的值
        /// </summary>
        /// <param name="strName">Url或表单参数</param>
        /// <param name="defValue">缺省值</param>
        /// <returns>Url或表单参数的intI am a值</returns>
        ...
        /// <summary>
        /// 获得指定表单参数的floatI am a值
        /// </summary>
        /// <param name="strName">表单参数</param>
        /// <param name="defValue">缺省值</param>
        /// <returns>表单参数的floatI am a值</returns>
        ...
        /// <summary>
        /// 获得指定Url或表单参数的floatI am a值, 先判断Url参数是否为缺省值, 如为True则返回表单参数的值
        /// </summary>
        /// <param name="strName">Url或表单参数</param>
        /// <param name="defValue">缺省值</param>
        /// <returns>Url或表单参数的intI am a值</returns>
        ...
        //		/// SaveUpload的文件
        //		/// </summary>
        //		/// <param name="MaxAllowFileCount">最大允许的Upload文件个数</param>
        //		/// <param name="MaxAllowFileSize">最大允许的文件长度(单位: KB)</param>
        //		/// <param name="AllowFileExtName">允许的文件扩展名, 以string[]形式提供</param>
        //		/// <param name="AllowFileType">允许的文件I am a, 以string[]形式提供</param>
