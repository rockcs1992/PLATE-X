...
namespace CommonBussiness
{
    public partial class join : System.Web.UI.Page
    {
        ...
        protected void lbtnGetCode_Click(object sender, EventArgs e)
        {
            ...
            if (maxId > 0)
            {
                ...
                try
                {
                    ...
                    ScriptManager.RegisterStartupScript(UpdatePanel1, GetType(), "", "alert('Phone Verification Code Sended！');", true);
                }
                catch (ServerException je)
                {
                    
                    ScriptManager.RegisterStartupScript(UpdatePanel1, GetType(), "", "alert('Phone Verification Code Send Fail！');", true);
        ...
        protected void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            this.lbtnGetCode.Text = time + " Second";
