...
KindEditor.lang({
	...
	removeformat : 'Delete格式',
	image : '图片',
	multiimage : '批量图片Upload',
	flash : 'Flash',
	media : '视音频',
	table : '表格',
	tablecell : '单$格',
	...
	editMedia : '视音频属性',
	deleteMedia : 'Delete视音频',
	editLink : '超级链接属性',
	deleteLink : '取消超级链接',
	editAnchor : '锚点属性',
	deleteAnchor : 'Delete锚点',
	tableprop : '表格属性',
	tablecellprop : '单$格属性',
	tableinsert : '插入表格',
	tabledelete : 'Delete表格',
	tablecolinsertleft : '左侧插入列',
	tablecolinsertright : '右侧插入列',
	tablerowinsertabove : '上方插入行',
	tablerowinsertbelow : '下方插入行',
	tablerowmerge : '向下合并单$格',
	tablecolmerge : '向右合并单$格',
	tablerowsplit : '拆分行',
	tablecolsplit : '拆分列',
	tablecoldelete : 'Delete列',
	tablerowdelete : 'Delete行',
	noColor : '无颜色',
	...
	invalidJson : '服务器发生故障。',
	uploadSuccess : 'Upload成功。',
	cutError : '您的浏览器安全设置不允许使用剪切Action，请使用快捷键(Ctrl+X)来完成。',
	copyError : '您的浏览器安全设置不允许使用复制Action，请使用快捷键(Ctrl+C)来完成。',
	pasteError : '您的浏览器安全设置不允许使用粘贴Action，请使用快捷键(Ctrl+V)来完成。',
	ajaxLoading : '加载中，请稍候 ...',
	uploadLoading : 'Upload中，请稍候 ...',
	uploadError : 'Upload错误',
	'plainpaste.comment' : '请使用快捷键(Ctrl+V)把内容粘贴到下面的方框里。',
	'wordpaste.comment' : '请使用快捷键(Ctrl+V)把内容粘贴到下面的方框里。',
	'code.pleaseInput' : '请输入程序代码。',
	'link.url' : 'URL',
	'link.linkType' : '打开I am a',
	'link.newWindow' : '新窗口',
	...
	'image.localImage' : '本地Upload',
	'image.remoteUrl' : '图片地址',
	'image.localUrl' : 'Upload文件',
	'image.size' : '图片大小',
	'image.width' : '宽',
	'image.height' : '高',
	...
	'multiimage.uploadDesc' : '允许用户同时Upload<%=uploadLimit%>张图片，单张图片容量不超过<%=sizeLimit%>',
	'multiimage.startUpload' : '开始Upload',
	'multiimage.clearAll' : 'All 清空',
	'multiimage.insertAll' : 'All 插入',
	'multiimage.queueLimitExceeded' : '文件Quantity超过限制。',
	'multiimage.fileExceedsSizeLimit' : '文件大小超过限制。',
	'multiimage.zeroByteFile' : '无法Upload空文件。',
	'multiimage.invalidFiletype' : '文件I am a不correct。',
	'multiimage.unknownError' : '发生异常，无法Upload。',
	'multiimage.pending' : '等待Upload',
	'multiimage.uploadError' : 'Upload失败',
	...
	'filemanager.fileName' : 'Item Name',
	'filemanager.fileSize' : '大小',
	'filemanager.fileType' : 'I am a',
	'insertfile.url' : 'URL',
		...
		edit : function() {
			...
			self.plugin.imageDialog({
				...
				clickFn : function(url, title, width, height, border, align) {
					...
					// Bugfix: [Firefox] Upload图片后，总是出现正在加载的样式，需要延迟执行hideDialog
					setTimeout(function() {
						self.hideDialog().focus();
					}, 0);
				}
...
KindEditor.plugin('table', function(K) {
	...
	self.plugin.table = {
		...
		rowmerge : function() {
			...
			var cellIndex = cell.cellIndex; // 下一行单$格的index
			if (nextRow.cells.length <= cellIndex) {
				return;
			}
			var nextCell = nextRow.cells[cellIndex]; // 下一行单$格
			// 上下行的colspan不一致时不能合并
