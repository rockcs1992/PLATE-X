...
namespace CommonBussiness
{
    public partial class Import : System.Web.UI.Page
    {
        ...
        /// <returns></returns>
        protected string GetBooks(object brandId)
        {
            StringBuilder sb = new StringBuilder();
            //DataSet ds = BrandAndBookService.GetList("brandId = " + brandId);
            //if (ds.Tables[0].Rows.Count > 0)
            //{
            //    ImgInfo item = null;
            //    foreach (DataRow dr in ds.Tables[0].Rows)
            //    {
            //        item = ImgInfoService.GetModel(Convert.ToInt32(dr["bookId"]));
            //        if (item != null)
            //        {
        ...
        {            
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=导出个人会员信息.xls");
