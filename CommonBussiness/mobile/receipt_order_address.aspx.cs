...
{
    public partial class receipt_order_address : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = AreaInfoService.GetList("id = 1");
        ...
        {
            location_c.Items.Clear();
            DataSet ds = AreaInfoService.GetList("parentId = " + location_p.SelectedValue);
            if (ds.Tables[0].Rows.Count > 0)
            {
                location_c.DataSource = ds;
                location_c.DataTextField = "areaName";
