        ...
        $("form :input").blur(function () {
            ...
            if ($(this).is("#password")) {
                ...
                if (this.value == "" || this.value.length < 6 || this.value.length > 12) {
                    ...
                    var hdw1 = $("<span class='a2 righta'>Right</span>");
            ...
            if ($(this).is("#tel")) {
                ...
                if (this.value == "" || this.value.length != 11) {
                    ...
                    var hdw1 = $("<span class='a2 error'>Phone Is Wrong</span>");
            ...
            if ($(this).is("#username")) {
                if (this.value == "") {
                    var hdw1 = $("<span class='a2 error'>Verification Code Is Wrong！</span>");
                    $(this).parent().append(hdw1);
                } else {
                    getCode(this.value);
                }
    ...
    $.ajax(
	        {
	            ...
	            success: function (msg) {
	                if ($.trim(msg) != "") {
	                    code = $.trim(msg);
	                    if (code != obj) {
	                        var hdw1 = $("<span class='a2 error'>Image Verification Code不correct，请重新输入！</span>");
