...
namespace CommonBussiness.mobile
{
    public partial class car : System.Web.UI.Page
    {
        ...
        /// <returns></returns>
        protected string GetClass(object sel) 
        {
            int s = Convert.ToInt32(sel);
            if(s == 1)
            {
                return "check_label on";
            }
            return "check_label";
        }
        /// <summary>
        ...
        private void BindData()
        {
            ...
            if (user != null)
            {
                ...
                {
                    ViewState["productCount"] = ds.Tables[0].Rows.Count;
        ...
        protected string GetLogin() 
        {
            ...
            if(user == null)
            {
                return "<a href=\"login.html\" class=\"reBtn\" style=\"background-color:#fff; border:1px red solid; color:red; \">Login</a>";
            }
            return "";
        }
