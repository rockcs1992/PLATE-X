<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="otherInfo.aspx.cs" Inherits="CommonBusiness.admin.otherInfo" %>
...
<div class="rcont">
    <div class="news">
        ...
        图片：<asp:FileUpload ID="FileUpload1" runat="server" /><asp:Label ID="lblURL" runat="server" Text=""></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;<br /><br />
        ...
        <br /><br />
            ...
            <asp:DropDownList ID="ddlCate" runat="server" Width="200px" AutoPostBack="true" 
                onselectedindexchanged="ddlCate_SelectedIndexChanged" >
            </asp:DropDownList>
            <asp:DropDownList ID="ddlSon" runat="server" Width="200px" >
            </asp:DropDownList>            
            </ContentTemplate>
            </asp:UpdatePanel>
        <br />
