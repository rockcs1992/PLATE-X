<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="propertyValue.aspx.cs" Inherits="CommonBussiness.admin.propertyValue" %>

<!doctype html>
<html>
<head>
<meta charset="utf-8">
<title>产品属性值范围设置</title>
...
<div class="rtitle" >产品属性值范围信息</div>
<div class="rcont" style=" min-height:500px;">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center";>
    	<td bgcolor="#eeeeee" align="left" colspan="5">
                    <input type="button" value="属性值范围添加" onclick="overKeyWordDiv()">
                </td>
                <td bgcolor="#eeeeee" align="left" colspan="2">
                    <asp:DropDownList ID="ddlSelProductType" runat="server" AutoPostBack="true" 
                    onselectedindexchanged="ddlSelProductType_SelectedIndexChanged" Width="200px"> </asp:DropDownList>
                    <asp:DropDownList ID="ddlSelOne" runat="server" Width="200px" onselectedindexchanged="ddlSelOne_SelectedIndexChanged" AutoPostBack="true" ></asp:DropDownList>
                    <asp:DropDownList ID="ddlSelTwo" runat="server" Width="200px"></asp:DropDownList>
        ...
        <asp:Repeater ID="repInfo" runat="server" onitemcommand="repInfo_ItemCommand">
            <ItemTemplate>
                <tr>
                    ...
                    <td><%#GetName(Eval("parentId"))%></td>   
                    <td><%#GetName(Eval("properId"))%></td>   
...
<ContentTemplate>
            <table class="cf" style="width: 600px;" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    onselectedindexchanged="ddlOne_SelectedIndexChanged"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left">
                        <asp:DropDownList ID="ddlTwo" runat="server" Width="200px"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left">
                        <asp:TextBox ID="txtPropertyValue" runat="server" Width="200px"></asp:TextBox>
                    </td>
                </tr>                
                <tr>
