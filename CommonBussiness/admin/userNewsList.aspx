<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userNewsList.aspx.cs" Inherits="CommonBusiness.admin.userNewsList" %>
...
<div class="rcont">
    ...
    <table class="tab_list" width="100%" cellpadding="0" cellspacing="0" border="0" align="center";>
        ...
        <asp:Repeater ID="Repeater1" runat="server" onitemcommand="Repeater1_ItemCommand">
            <ItemTemplate>
                <tr>
                    ...
                    <td ><%#Eval("areaId").ToString() == "1" ? "<span style='color:green'>通过</span>" : Eval("areaId").ToString() == "2" ? "<span style='color:red'>未通过</span>" : "未审核"%></td>                   
                    <td><%#GetUserName(Eval("add_userid"))%></td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
        <tr><td class="tleft" style="background:#eee;" colspan="10"></td></tr>
        ...
        <asp:Button ID="btnAdd" runat="server" Text="添加"  OnClick="btnAdd_Click" Visible="false" />
       </td></tr>
    </table>
