<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="infoType.aspx.cs" Inherits="CommonBusiness.admin.infoType" %>
...
<div class="rcont">
    ...
    <table class="tab_list" width="100%" cellpadding="0" cellspacing="0" border="0" align="center";>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td ><asp:Label ID="lblId" runat="server" Text='<%#Eval("Id") %>' Visible="false"></asp:Label><%#Eval("id") %></td>
                     ...
                     <td>
                        <asp:Label ID="Label1" runat="server" Text='<%#GetParentName(Eval("parentId")) %>'></asp:Label></td>   
                    
                    <td><asp:Label ID="lblOrder" runat="server" Text='<%#Eval("status") %>'></asp:Label></td>
                    <td><img src="<%#Eval("remark") %>" style="width:100px; height:100px;" /></td>
                    <td><asp:LinkButton
        ...
        <td colspan="9" class="tright" style="background:#eee;"><asp:Label ID="lblUrl"
                runat="server"></asp:Label>
            <asp:Label ID="lblImg" runat="server" Text="图片："></asp:Label>
            <asp:FileUpload ID="FileUpload1" runat="server" />
            <asp:DropDownList ID="ddlParent" runat="server">
            </asp:DropDownList>
            名称：<asp:TextBox ID="txtTitle" runat="server" Height="30px"></asp:TextBox>&nbsp;顺序号：<asp:TextBox ID="txtOrder" runat="server" Height="30px"></asp:TextBox>&nbsp;<asp:Button ID="Button1" runat="server" Text=" 保存分类 " onclick="Button1_Click" /><asp:Label
