...
//  二、<input  onfocus="WdatePicker({lang:'zh-cn'})">

var bMoveable=true;
var strFrame;

document.writeln('<iframe id="endDateLayer" name="endDateLayer" frameborder="0" width="162" height="195" scrolling="no" style="position: absolute;  z-index: 29998; display: none"></iframe>');
strFrame='<style>';
strFrame+='INPUT.button{BORDER: #63A3E9 1px solid;';
strFrame+='BACKGROUND-COLOR: #63A3E9;font-family:"Microsoft YaHei","微软雅黑";}';
...
strFrame += '        title="点击这里选择年份"><span  id=meizzYearHead name="meizzYearHead"></span></td>';
...
strFrame+='        title="点击这里选择月份"><span id=meizzMonthHead name="" ></span></td>';
...
strFrame+='    <table border=0 cellspacing=0 cellpadding=0 width=100% BORDERCOLORLIGHT=#63A3E9 BORDERCOLORDARK=#FFFFFF bgcolor=#f8f8f8 width=160 height=120 >';
...
function setday(tt,obj) //主调函数
{
 ...
 dads.top = (ttyp=="text") ? ttop+thei+10 : ttop+thei+6;
 dads.left = tleft;
