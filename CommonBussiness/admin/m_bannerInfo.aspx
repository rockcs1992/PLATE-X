<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="m_bannerInfo.aspx.cs" Inherits="CommonBusiness.admin.m_bannerInfo" %>
...
<div class="rcont" style=" min-height:500px;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center";>
    	...
    	<tr>
            ...
            <td class="r_cont">
                <asp:TextBox ID="txtTitleEn" runat="server" Width="600px"></asp:TextBox>
               </td></tr>
        <tr>
         <td class="r_tab2">链接</td>
            <td class="r_cont"><asp:TextBox ID="txtLinkUrl" runat="server" Width="600px"></asp:TextBox></td>
        </tr>
        <tr>
        <td class="r_tab2">顺序号</td>
            <td class="r_cont"><asp:TextBox ID="txtOrder" runat="server" Width="600px"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="r_tab2">图片</td>
            <td class="r_cont">
                <asp:FileUpload ID="FileUpload1" runat="server" /><asp:Label ID="lblURL" runat="server" Text=""></asp:Label>（640px * 340px）</td>
        </tr>        
        <tr style="display:none;">
