<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="onlineMessage.aspx.cs" Inherits="CommonBusiness.admin.onlineMessage" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><%#Eval("tel")%></td>
                     ...
                     <td><%#Eval("email")%></td>
                         <td><%# Text.Left(Eval("mesContent").ToString(), 20)%>...</td>
